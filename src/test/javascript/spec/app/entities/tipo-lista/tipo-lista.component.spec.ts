...
import { TipoListaComponent } from 'app/entities/tipo-lista/tipo-lista.component';
...
describe('Component Tests', () => {
  describe('TipoLista Management Component', () => {
    let comp: TipoListaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TipoListaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tipoListas && comp.tipoListas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
